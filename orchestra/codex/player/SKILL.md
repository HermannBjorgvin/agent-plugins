---
name: player
description: Run as a coding player and report progress, questions and completion to a designated orchestrator.
---
...
orchestrator. `report.sh --orchestrator` alone prints the current binding.
